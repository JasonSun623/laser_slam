...
class SonarSensorLayer : public costmap_2d::CostmapLayer
{
public:
  enum InputSensorType
  {
...
private:
  ...
  void bufferIncomingRangeMsg(const range_sensor_layer::sonar_msgsConstPtr& range_message);
  void processRangeMsg(range_sensor_layer::sonar_msgs& range_message);
  void processFixedRangeMsg(range_sensor_layer::sonar_msgs& range_message);
  void processVariableRangeMsg(range_sensor_layer::sonar_msgs& range_message);
  ...
  boost::function<void (range_sensor_layer::sonar_msgs& range_message)> processRangeMessageFunc_;
  boost::mutex range_message_mutex_;
  std::list<range_sensor_layer::sonar_msgs> range_msgs_buffer_;
  std::list<range_sensor_layer::sonar_msgs> time_range_msgs_buffer_;
  //message_filters::Subscriber<range_sensor_layer::sonar_msgs>* sonar_sub_;
  //tf::MessageFilter<range_sensor_layer::sonar_msgs>* sonar_filter_;
...
class PointTimeSensorLayer : public costmap_2d::CostmapLayer
{
public:
  enum InputSensorType
  {
